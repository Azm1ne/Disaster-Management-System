...
const resources = {
  en: {
    translation: {
      ...
      admin: {
        title: 'Disaster registration',
        subtitle: 'Declare, edit, and close disasters; place affected areas and camps under them.',
        empty: 'No disasters registered yet.',
        declareCta: 'Declare new disaster',
        declareTitle: 'Declare a new disaster',
        declareSubmit: 'Declare disaster',
        code: 'Code',
        type: 'Type',
        typeValue: { FLOOD: 'Flood', CYCLONE: 'Cyclone' },
        nameEn: 'Name (English)',
        nameBn: 'Name (Bangla)',
        submitting: 'Saving…',
        error: 'That did not save. Try again.',
        statusLabel: 'Status',
        statusValue: { ACTIVE: 'Active', CLOSED: 'Closed' },
        close: 'Close disaster',
        closeConfirm: 'Confirm close',
        cancel: 'Cancel',
        detail: {
          view: 'Overview',
          boundary: 'Redraw boundary',
          addArea: 'Add affected area',
          addCamp: 'Add camp',
          history: 'Geometry history',
          areasCount: 'Affected areas',
          campsCount: 'Camps',
          boundarySubmit: 'Save boundary',
          areaSubmit: 'Add area',
          campCode: 'Camp code',
          campCapacity: 'Capacity',
          campInitialPopulation: 'Initial population',
          campSubmit: 'Register camp',
        },
        history: {
          empty: 'No geometry changes recorded yet.',
          subject: 'Showing history for',
          subjectDisaster: 'This disaster’s boundary',
          subjectArea: 'Affected area: {{name}}',
          entryCreated: 'First boundary drawn',
          entryUpdated: 'Boundary redrawn',
          actor: 'User #{{id}}',
  ...
  bn: {
    translation: {
      ...
      admin: {
        title: 'দুর্যোগ নিবন্ধন',
        subtitle: 'দুর্যোগ ঘোষণা, সম্পাদনা ও বন্ধ করুন; এর অধীনে ক্ষতিগ্রস্ত এলাকা ও ক্যাম্প স্থাপন করুন।',
        empty: 'এখনও কোনো দুর্যোগ নিবন্ধিত হয়নি।',
        declareCta: 'নতুন দুর্যোগ ঘোষণা করুন',
        declareTitle: 'একটি নতুন দুর্যোগ ঘোষণা করুন',
        declareSubmit: 'দুর্যোগ ঘোষণা করুন',
        code: 'কোড',
        type: 'ধরন',
        typeValue: { FLOOD: 'বন্যা', CYCLONE: 'ঘূর্ণিঝড়' },
        nameEn: 'নাম (ইংরেজি)',
        nameBn: 'নাম (বাংলা)',
        submitting: 'সংরক্ষণ হচ্ছে…',
        error: 'সংরক্ষণ ব্যর্থ হয়েছে। আবার চেষ্টা করুন।',
        statusLabel: 'অবস্থা',
        statusValue: { ACTIVE: 'সক্রিয়', CLOSED: 'বন্ধ' },
        close: 'দুর্যোগ বন্ধ করুন',
        closeConfirm: 'বন্ধ করা নিশ্চিত করুন',
        cancel: 'বাতিল',
        detail: {
          view: 'সারসংক্ষেপ',
          boundary: 'সীমানা পুনরায় আঁকুন',
          addArea: 'ক্ষতিগ্রস্ত এলাকা যোগ করুন',
          addCamp: 'ক্যাম্প যোগ করুন',
          history: 'সীমারেখার ইতিহাস',
          areasCount: 'ক্ষতিগ্রস্ত এলাকা',
          campsCount: 'ক্যাম্প',
          boundarySubmit: 'সীমানা সংরক্ষণ করুন',
          areaSubmit: 'এলাকা যোগ করুন',
          campCode: 'ক্যাম্প কোড',
          campCapacity: 'ধারণক্ষমতা',
          campInitialPopulation: 'প্রাথমিক জনসংখ্যা',
          campSubmit: 'ক্যাম্প নিবন্ধন করুন',
        },
        history: {
          empty: 'এখনও কোনো সীমারেখা পরিবর্তন রেকর্ড করা হয়নি।',
          subject: 'যার ইতিহাস দেখানো হচ্ছে',
          subjectDisaster: 'এই দুর্যোগের সীমানা',
          subjectArea: 'ক্ষতিগ্রস্ত এলাকা: {{name}}',
          entryCreated: 'প্রথম সীমানা আঁকা হয়েছে',
          entryUpdated: 'সীমানা পুনরায় আঁকা হয়েছে',
          actor: 'ব্যবহারকারী #{{id}}',
          vertexCount: '{{count}}টি শীর্ষবিন্দু',
        },
      },
