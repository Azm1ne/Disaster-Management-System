    ...
    translation: {
      ...
      funds: {
        donate: {
          ...
          subtitle: 'Give to a disaster fund. This is a modeled donation — no real payment is taken.',
          disaster: 'Disaster',
          disasterPlaceholder: 'Choose a disaster',
          amount: 'Amount',
          amountPlaceholder: '0',
          submit: 'Donate',
          submitting: 'Donating…',
          error: 'That donation did not go through. Please try again.',
        },
        impact: {
          title: 'Your impact',
          subtitle: 'Every taka you have given, traced from your donation to the camps it reached.',
          you: 'You gave',
          fund: 'Shared fund',
        },
        report: {
          title: 'Unaccounted funds',
          subtitle: 'Money in versus aid out, per disaster — the audit trail behind every taka.',
          disaster: 'Disaster',
          donated: 'Donated',
          procured: 'Procured',
        ...
        procure: {
          title: 'Procure resources',
          subtitle: 'Spend a disaster fund balance into a resource quantity for a camp.',
          disaster: 'Disaster',
          disasterPlaceholder: 'Choose a disaster',
          camp: 'Camp',
          campPlaceholder: 'Choose a camp',
          resource: 'Resource',
          amount: 'Amount',
          submit: 'Procure',
          submitting: 'Procuring…',
          error: 'That procurement did not go through — it may exceed the available fund balance.',
        },
      },
    },
  },
  bn: {
    translation: {
      ...
      funds: {
        donate: {
          title: 'অনুদান দিন',
          subtitle: 'একটি দুর্যোগ তহবিলে অনুদান দিন। এটি একটি মডেল করা অনুদান — কোনো প্রকৃত অর্থ প্রদান নেওয়া হয় না।',
          disaster: 'দুর্যোগ',
          disasterPlaceholder: 'একটি দুর্যোগ বেছে নিন',
          amount: 'পরিমাণ',
          amountPlaceholder: '০',
          submit: 'অনুদান দিন',
          submitting: 'অনুদান হচ্ছে…',
          error: 'অনুদানটি সম্পন্ন হয়নি। আবার চেষ্টা করুন।',
        },
        impact: {
          title: 'আপনার অবদান',
          subtitle: 'আপনার দেওয়া প্রতিটি টাকা, অনুদান থেকে যে ক্যাম্পগুলোতে পৌঁছেছে তা পর্যন্ত অনুসরণ করা।',
          you: 'আপনি দিয়েছেন',
          fund: 'যৌথ তহবিল',
        },
        report: {
          title: 'অনিয়ন্ত্রিত তহবিল',
          subtitle: 'প্রতিটি দুর্যোগে আয় বনাম ব্যয় — প্রতিটি টাকার হিসাব-নিকাশ।',
          disaster: 'দুর্যোগ',
          donated: 'অনুদান',
          procured: 'ক্রয়কৃত',
          unaccounted: 'অনিয়ন্ত্রিত',
          total: 'সর্বমোট',
        },
        procure: {
          title: 'সম্পদ ক্রয় করুন',
          subtitle: 'একটি ক্যাম্পের জন্য দুর্যোগ তহবিলের স্থিতি থেকে সম্পদের পরিমাণে ব্যয় করুন।',
          disaster: 'দুর্যোগ',
          disasterPlaceholder: 'একটি দুর্যোগ বেছে নিন',
          camp: 'ক্যাম্প',
          campPlaceholder: 'একটি ক্যাম্প বেছে নিন',
          resource: 'সম্পদ',
          amount: 'পরিমাণ',
          submit: 'ক্রয় করুন',
          submitting: 'ক্রয় হচ্ছে…',
          error: 'ক্রয়টি সম্পন্ন হয়নি — এটি তহবিলের সহজলভ্য স্থিতি অতিক্রম করতে পারে।',
        },
      },
    },
  },
