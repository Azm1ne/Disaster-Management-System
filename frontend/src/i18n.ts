...
const resources = {
  en: {
    translation: {
      ...
      volunteers: {
        ...
        subtitle: 'Shifts derived from open alerts, ranked skill × distance × urgency.',
        empty: 'No shifts right now.',
        skillGap: 'Skill coverage',
        skill: { MEDICAL: 'Medical', LOGISTICS: 'Logistics', SECURITY: 'Security', ENGINEERING: 'Engineering' },
        statusValue: { OPEN: 'Open', ASSIGNED: 'Assigned', CANCELLED: 'Cancelled' },
        method: { PUSH: 'Push-assigned', SELF: 'Self-accepted' },
        urgency: 'Urgency',
        assignedVia: '{{name}} · {{method}}',
        showCandidates: 'Show candidates',
        hideCandidates: 'Hide candidates',
        loadingCandidates: 'Ranking volunteers…',
        candidateName: '{{name}}',
        hasSkill: 'Has {{skill}}',
        missingSkill: 'No matching skill',
        distanceAway: '{{km}} km away',
        assign: 'Assign',
        myShifts: 'My shifts',
        myShiftsBlurb: 'Everything assigned to you — whether a coordinator sent it or you took it yourself.',
        noMyShifts: 'No shifts assigned to you yet.',
        openShifts: 'Open shifts',
        openShiftsBlurb: 'Pick up a shift that needs a volunteer.',
        noOpenShifts: 'No open shifts right now.',
        acceptShift: 'Accept shift',
        viewRoute: 'View route',
        loadingRoute: 'Finding a route…',
        routeSummary: '{{km}} km · about {{minutes}} min',
  ...
  bn: {
    translation: {
      ...
      volunteers: {
        title: 'স্বেচ্ছাসেবক মিলকরণ',
        subtitle: 'খোলা সতর্কতা থেকে তৈরি শিফট, দক্ষতা × দূরত্ব × জরুরিতা অনুযায়ী ক্রমবিন্যস্ত।',
        empty: 'এই মুহূর্তে কোনো শিফট নেই।',
        skillGap: 'দক্ষতা কভারেজ',
        skill: { MEDICAL: 'চিকিৎসা', LOGISTICS: 'সরবরাহ', SECURITY: 'নিরাপত্তা', ENGINEERING: 'প্রকৌশল' },
        statusValue: { OPEN: 'খোলা', ASSIGNED: 'নিয়োজিত', CANCELLED: 'বাতিল' },
        method: { PUSH: 'সমন্বয়কারী কর্তৃক নিয়োজিত', SELF: 'নিজে গ্রহণ করেছেন' },
        urgency: 'জরুরিতা',
        assignedVia: '{{name}} · {{method}}',
        showCandidates: 'প্রার্থী দেখুন',
        hideCandidates: 'প্রার্থী লুকান',
        loadingCandidates: 'স্বেচ্ছাসেবক ক্রমবিন্যস্ত হচ্ছে…',
        candidateName: '{{name}}',
        hasSkill: '{{skill}} দক্ষতা আছে',
        missingSkill: 'মিলযুক্ত দক্ষতা নেই',
        distanceAway: '{{km}} কিমি দূরে',
        assign: 'নিয়োগ করুন',
        myShifts: 'আমার শিফট',
        myShiftsBlurb: 'আপনাকে যা কিছু দেওয়া হয়েছে — সমন্বয়কারী পাঠিয়েছেন বা আপনি নিজেই নিয়েছেন।',
        noMyShifts: 'আপনার জন্য এখনও কোনো শিফট নিয়োজিত হয়নি।',
        openShifts: 'খোলা শিফট',
        openShiftsBlurb: 'স্বেচ্ছাসেবক প্রয়োজন এমন একটি শিফট বেছে নিন।',
        noOpenShifts: 'এই মুহূর্তে কোনো খোলা শিফট নেই।',
        acceptShift: 'শিফট গ্রহণ করুন',
        viewRoute: 'রুট দেখুন',
        loadingRoute: 'রুট খোঁজা হচ্ছে…',
